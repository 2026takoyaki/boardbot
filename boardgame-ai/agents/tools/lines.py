...
_STRATEGY: dict[str, str] = {
    ...
    "ww_doppelganger": "도플갱어는 다른 플레이어의 카드를 몰래 확인해 그 역할을 복사합니다. 강력한 역할(예언자, 강도)을 노리세요.",
    "ww_seer": "예언자는 다른 플레이어 카드 한 장 또는 센터 카드 두 장을 볼 수 있습니다. 의심스러운 플레이어의 카드를 확인하는 것이 효과적입니다.",
    "ww_robber": "강도는 다른 플레이어와 카드를 교환할 수 있습니다. 강력한 역할을 가진 플레이어의 카드를 노리세요.",
    "ww_troublemaker": "말썽쟁이는 두 플레이어의 카드를 교환합니다. 늑대인간으로 의심되는 플레이어와 다른 플레이어의 카드를 바꿔 혼란을 주세요.",
    "ww_drunk": "주정뱅이는 센터 카드 중 하나와 자신의 카드를 교환합니다. 자신의 새 역할을 알 수 없으니 낮 토론에서 신중하게 행동하세요.",
    "ww_insomniac": "불면증환자는 밤이 끝난 후 자신의 최종 카드를 확인합니다. 카드가 바뀌었다면 누군가 손을 댔다는 단서가 됩니다.",
}
